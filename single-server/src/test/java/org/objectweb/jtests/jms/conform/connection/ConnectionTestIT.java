 ...
 * @version $Id: ConnectionTestIT.java,v 1.2 2007/06/15 20:55:20 csuconic Exp $
 */
public class ConnectionTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(ConnectionTestIT.class);
   }

   public ConnectionTestIT(final String name)
   {
      super(name);
   }
}
