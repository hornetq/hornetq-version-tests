 ...
 * @version $Id: MessageHeaderTestIT.java,v 1.1 2007/03/29 04:28:36 starksm Exp $
 */
public class MessageHeaderTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(MessageHeaderTestIT.class);
   }

   public MessageHeaderTestIT(final String name)
   {
      super(name);
   }
}
