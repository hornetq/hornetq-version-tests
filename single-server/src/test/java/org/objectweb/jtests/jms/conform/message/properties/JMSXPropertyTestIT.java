 ...
 * @version $Id: JMSXPropertyTestIT.java,v 1.2 2007/06/19 23:32:34 csuconic Exp $
 */
public class JMSXPropertyTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(JMSXPropertyTestIT.class);
   }

   public JMSXPropertyTestIT(final String name)
   {
      super(name);
   }
}
