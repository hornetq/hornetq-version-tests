 ...
 * @version $Id: MessagePropertyTestIT.java,v 1.1 2007/03/29 04:28:34 starksm Exp $
 */
public class MessagePropertyTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(MessagePropertyTestIT.class);
   }

   public MessagePropertyTestIT(final String name)
   {
      super(name);
   }
}
