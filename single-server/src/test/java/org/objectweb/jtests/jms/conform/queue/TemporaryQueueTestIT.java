 ...
 * @version $Id: TemporaryQueueTestIT.java,v 1.1 2007/03/29 04:28:37 starksm Exp $
 */
public class TemporaryQueueTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(TemporaryQueueTestIT.class);
   }

   public TemporaryQueueTestIT(final String name)
   {
      super(name);
   }
}
