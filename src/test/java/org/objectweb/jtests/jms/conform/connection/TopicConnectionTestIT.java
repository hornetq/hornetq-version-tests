...
public class TopicConnectionTestIT extends PubSubTestCase
{
   ...
   {
      return new TestSuite(TopicConnectionTestIT.class);
   }

   public TopicConnectionTestIT(final String name)
   {
      super(name);
   }
}
