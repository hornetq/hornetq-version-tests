 ...
 * @version $Id: MessageBodyTestIT.java,v 1.1 2007/03/29 04:28:37 starksm Exp $
 */
public class MessageBodyTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(MessageBodyTestIT.class);
   }
   ...
   public MessageBodyTestIT(final String name)
   {
      super(name);
   }
