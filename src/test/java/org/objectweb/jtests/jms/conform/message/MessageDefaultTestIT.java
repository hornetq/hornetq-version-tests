 ...
 * @version $Id: MessageDefaultTestIT.java,v 1.1 2007/03/29 04:28:37 starksm Exp $
 */
public class MessageDefaultTestIT extends JMSTestCase
{
   ...
   {
      return new TestSuite(MessageDefaultTestIT.class);
   }

   public MessageDefaultTestIT(final String name)
   {
      super(name);
   }
}
