 ...
 * @version $Id: MessageTypeTestIT.java,v 1.1 2007/03/29 04:28:37 starksm Exp $
 */
public class MessageTypeTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(MessageTypeTestIT.class);
   }

   public MessageTypeTestIT(final String name)
   {
      super(name);
   }
}
