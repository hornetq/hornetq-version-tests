 ...
 * @version $Id: MessagePropertyConversionTestIT.java,v 1.1 2007/03/29 04:28:34 starksm Exp $
 */
public class MessagePropertyConversionTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(MessagePropertyConversionTestIT.class);
   }

   public MessagePropertyConversionTestIT(final String name)
   {
      super(name);
   }
}
