 ...
 * @version $Id: QueueBrowserTestIT.java,v 1.2 2007/06/19 23:32:35 csuconic Exp $
 */
public class QueueBrowserTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(QueueBrowserTestIT.class);
   }

   public QueueBrowserTestIT(final String name)
   {
      super(name);
   }
}
