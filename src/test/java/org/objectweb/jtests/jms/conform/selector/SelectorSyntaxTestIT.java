 ...
 * @version $Id: SelectorSyntaxTestIT.java,v 1.1 2007/03/29 04:28:35 starksm Exp $
 */
public class SelectorSyntaxTestIT extends PTPTestCase
{
   /**
   ...
   {
      return new TestSuite(SelectorSyntaxTestIT.class);
   }

   public SelectorSyntaxTestIT(final String name)
   {
      super(name);
   }
}
