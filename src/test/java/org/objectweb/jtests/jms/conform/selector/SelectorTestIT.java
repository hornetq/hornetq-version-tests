 ...
 * @version $Id: SelectorTestIT.java,v 1.3 2007/10/02 14:59:35 csuconic Exp $
 */
public class SelectorTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(SelectorTestIT.class);
   }

   public SelectorTestIT(final String name)
   {
      super(name);
   }
}
