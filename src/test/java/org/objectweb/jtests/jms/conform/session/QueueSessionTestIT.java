 ...
 * @version $Id: QueueSessionTestIT.java,v 1.2 2007/06/19 23:32:35 csuconic Exp $
 */
public class QueueSessionTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(QueueSessionTestIT.class);
   }

   public QueueSessionTestIT(final String name)
   {
      super(name);
   }
}
