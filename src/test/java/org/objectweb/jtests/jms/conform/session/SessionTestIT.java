 ...
 * @version $Id: SessionTestIT.java,v 1.2 2007/06/19 23:32:35 csuconic Exp $
 */
public class SessionTestIT extends PTPTestCase
{
   ...
   {
      return new TestSuite(SessionTestIT.class);
   }

   public SessionTestIT(final String name)
   {
      super(name);
   }
}
