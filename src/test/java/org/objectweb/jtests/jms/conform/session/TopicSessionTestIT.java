 ...
 * @version $Id: TopicSessionTestIT.java,v 1.2 2007/06/19 23:32:35 csuconic Exp $
 */
public class TopicSessionTestIT extends PubSubTestCase
{
   ...
   {
      return new TestSuite(TopicSessionTestIT.class);
   }

   public TopicSessionTestIT(final String name)
   {
      super(name);
   }
}
