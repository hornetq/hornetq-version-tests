 ...
 * @version $Id: UnifiedSessionTestIT.java,v 1.1 2007/03/29 04:28:37 starksm Exp $
 * @since JMS 1.1
 */
public class UnifiedSessionTestIT extends UnifiedTestCase
{
   ...
   {
      return new TestSuite(UnifiedSessionTestIT.class);
   }

   public UnifiedSessionTestIT(final String name)
   {
      super(name);
   }
}
