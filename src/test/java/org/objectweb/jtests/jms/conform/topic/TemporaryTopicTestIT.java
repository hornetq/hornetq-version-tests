 ...
 * @version $Id: TemporaryTopicTestIT.java,v 1.1 2007/03/29 04:28:34 starksm Exp $
 */
public class TemporaryTopicTestIT extends PubSubTestCase
{
   ...
   {
      return new TestSuite(TemporaryTopicTestIT.class);
   }

   public TemporaryTopicTestIT(final String name)
   {
      super(name);
   }
}
